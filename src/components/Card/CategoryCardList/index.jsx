  ...
  return (
    <>
      {datas?.categories?.map((data) => (
        <div key={data.idCategory} className="md:w-1/5 bg-white border border-gray-500 rounded-xl shadow-xl overflow-hidden transform transition-transform hover:scale-105">
